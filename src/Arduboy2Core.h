...
#elif ARDUBOY4809
#define PIN_LEFT_BUTTON 15
#define LEFT_BUTTON_PORT PORTD_OUT
#define LEFT_BUTTON_PORTIN PORTD_IN
#define LEFT_BUTTON_DDR PORTD_DIR
#define LEFT_BUTTON_BIT 2

#define PIN_RIGHT_BUTTON 3
#define RIGHT_BUTTON_PORT PORTF_OUT
#define RIGHT_BUTTON_PORTIN PORTF_IN
#define RIGHT_BUTTON_DDR PORTF_DIR
#define RIGHT_BUTTON_BIT 5

#define PIN_UP_BUTTON 17
#define UP_BUTTON_PORT PORTD_OUT
#define UP_BUTTON_PORTIN PORTD_IN
#define UP_BUTTON_DDR PORTD_DIR
#define UP_BUTTON_BIT 0

#define PIN_DOWN_BUTTON 2
#define DOWN_BUTTON_PORT PORTA_OUT
#define DOWN_BUTTON_PORTIN PORTA_IN
#define DOWN_BUTTON_DDR PORTA_DIR
#define DOWN_BUTTON_BIT 0

#define PIN_A_BUTTON 4
#define A_BUTTON_PORT PORTC_OUT
#define A_BUTTON_PORTIN PORTC_IN
#define A_BUTTON_DDR PORTC_DIR
#define A_BUTTON_BIT 6

#define PIN_B_BUTTON 16
#define B_BUTTON_PORT PORTD_OUT
#define B_BUTTON_PORTIN PORTD_IN
#define B_BUTTON_DDR PORTD_DIR
